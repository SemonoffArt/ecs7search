...
Обрабатывает все CSV-файлы в ``data/zif2/ecs8busfaults/``, извлекает события
...
Результат сохраняется в ``data/zif2/bus_fault_events.json``.
"""
...
def rebuild_bus_fault_index(
    ...
    Параметры:
        ...
        output_path: итоговый JSON (``data/zif2/bus_fault_events.json``).
