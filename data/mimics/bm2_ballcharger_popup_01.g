...
vis 1
detect 1
bm2_ballcharger_popup_01: model
    . backgrflag 1
    ...
    . userdata "0033020BM120ABC_FeedRateSP  "
    ...
    . move 260,841 244,86
    inst POINTVAL 0 0
    . userdata "0020020BM120ABC_TotalCount  "
    . move 23,5 17,753
    ...
    inst pointvalent 0 0
    . userdata "0033020BM120ABC_BallWeighSP "
    . move 24,1255 8,8118
    ...
    inst POINTVAL 0 0
    . userdata "0020020BM120ABC_BallWeigh   "
    . move 23,5 10,5014
    ...
    renamedvars  \
        ...
        OutBitNo :: 0 \
        OutBitVal :: 1 \
        PointNo :: pointno("020BM120ABC_cmdWrite")
    ...
    renamedvars  \
        InBitNo :: 0 \
        OutBitNo :: 0 \
        PointNo :: pointno("020BM120ABC_ECSCtrl")
    font 1
    ...
    renamedvars  \
        InBitNo :: 0 \
        OutBitNo :: 0 \
        PointNo :: pointno("020BM120ABC_sManMode")
    inst fls_m_bitcheck 0 0
    ...
    renamedvars  \
        InBitNo :: 0 \
        OutBitNo :: 0 \
        PointNo :: pointno("020BM120ABC_sAutMode")
    inst pointvalent 0 0
    . userdata "0033020BM120ABC_ManComandSP "
    . move 21,417 33,0068
    ...
    frect 79,5000 70,0000 80,0000 69,5000 
    . userdata "0011020BM120ABC_ManMode     101 "
    . tran -2,98475 -2,79343e-007 0 2,75224e-007 -2,94075 0
    . move 263,348 241,286
    frect 79,5000 70,0000 80,0000 69,5000 
    . userdata "0011020BM120ABC_AutMode     101 "
    . tran -2,98475 -2,79343e-007 0 2,75224e-007 -2,94075 0
