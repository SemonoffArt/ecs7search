...
vis 1
detect 1
bm1_ballcharger_popup_01: model
    . backgrflag 1
    ...
    estyle 1
    ewidth 1
    background: frect 0,0000 0,0000 37,0000 50,0000 
    detect 1
    tcolor 17
    bcolor 0
    height 2
    ...
    . userdata "0033020BM110ABC_FeedRateSP  "
    ...
    . move 25,0559 24,755
    . scale 25,0559 24,755 0,361788 0,75019
    fcolor 24
    ecolor 24
    ...
    . move 260,841 244,86
    inst POINTVAL 0 0
    . userdata "0020020BM110ABC_TotalCount  "
    . move 25,0559 17,753
    . scale 25,0559 17,753 0,361788 0,75019
    ...
    . move 25,0559 15,2523
    . scale 25,0559 15,2523 0,361788 0,75019
    inst pointvalent 0 0
    . userdata "0033020BM110ABC_BallWeighSP "
    . move 24,1255 8,8118
    ...
    inst POINTVAL 0 0
    . userdata "0020020BM110ABC_BallWeigh   "
    . move 25,0559 10,5014
    . scale 25,0559 10,5014 0,361788 0,75019
    ...
    renamedvars  \
        ...
        OutBitNo :: 0 \
        OutBitVal :: 1 \
        PointNo :: pointno("020BM110ABC_cmdWrite")
    ...
    renamedvars  \
        InBitNo :: 0 \
        OutBitNo :: 0 \
        PointNo :: pointno("020BM110ABC_ECSCtrl")
    font 1
    ...
    renamedvars  \
        InBitNo :: 0 \
        OutBitNo :: 0 \
        PointNo :: pointno("020BM110ABC_sManMode")
    inst fls_m_bitcheck 0 0
    ...
    renamedvars  \
        InBitNo :: 0 \
        OutBitNo :: 0 \
        PointNo :: pointno("020BM110ABC_sAutMode")
    inst pointvalent 0 0
    . userdata "0033020BM110ABC_ManComandSP "
    . move 21,417 33,0068
    ...
    frect 79,5000 70,0000 80,0000 69,5000 
    . userdata "0011020BM110ABC_ManMode     101 "
    . tran -2,98475 -2,79343e-007 0 2,75224e-007 -2,94075 0
    . move 263,348 241,286
    frect 79,5000 70,0000 80,0000 69,5000 
    . userdata "0011020BM110ABC_AutMode     101 "
    . tran -2,98475 -2,79343e-007 0 2,75224e-007 -2,94075 0
    . move 263,329 232,961
    align 1 3
    text "Сбой связи" 12,5 60,5
    . userdata "0011020BM110ABC_FltCom      010 "
    . move 0,130231 -26,8615
    . scale 0,130231 -26,8615 1,12582 1,18779
    frect 79,5000 70,0000 80,0000 69,5000 
    . userdata "0011020BM110ABC_FltCom      101 "
    . move -215,284 -159,872
    . scale -215,284 -159,872 2,98475 2,94075
    ...
    ecolor 12
    ewidth 2
    line 65,0000 47,5000 90,0000 47,5000 
